...
public class Person implements java.io.Serializable {
	...
	public Person(java.lang.String name, java.lang.String SSN, java.util.Date DOB, org.tempuri.Address home,
			org.tempuri.Address office, org.tempuri.Person spouse, java.lang.String[] favoriteColors,
			java.lang.Long age) {
		this.name = name;
		this.SSN = SSN;
		this.DOB = DOB;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& ((this.SSN == null && other.getSSN() == null)
						|| (this.SSN != null && this.SSN.equals(other.getSSN())))
				&& ((this.DOB == null && other.getDOB() == null)
						|| (this.DOB != null && this.DOB.equals(other.getDOB())))
				&& ((this.home == null && other.getHome() == null)
						|| (this.home != null && this.home.equals(other.getHome())))
				&& ((this.office == null && other.getOffice() == null)
						|| (this.office != null && this.office.equals(other.getOffice())))
				&& ((this.spouse == null && other.getSpouse() == null)
						|| (this.spouse != null && this.spouse.equals(other.getSpouse())))
				&& ((this.favoriteColors == null && other.getFavoriteColors() == null) || (this.favoriteColors != null
	...
	public synchronized int hashCode() {
		...
		if (getFavoriteColors() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getFavoriteColors()); i++) {
