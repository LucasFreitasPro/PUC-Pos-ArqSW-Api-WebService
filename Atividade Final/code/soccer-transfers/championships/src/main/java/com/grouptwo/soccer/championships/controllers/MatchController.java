...
public class MatchController {
	...
	@PostMapping
	public ResponseEntity<Object> register(@PathVariable("championshipId") UUID championshipId, @PathVariable("seasonId") UUID seasonId, @RequestBody @Valid MatchRegisteringRequest matchRegisteringRequest, BindingResult bindingResult) {
		...
		if (championshipResponse != null) {
			...
			if (seasonResponse != null) {
				...
				if (matchResponse == null) {
					...
					return ResponseEntity.status(HttpStatus.CONFLICT).body(new ConflictResponse<EntityModel<MatchResponse>>("Match is already registered", this.matchResponseModelAssembler.toModel(matchResponse)));
				}
			} else {
